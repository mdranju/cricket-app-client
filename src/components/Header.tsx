    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-200">
      <nav className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <div className="text-sm font-medium text-amber-600 tracking-widest">
            C
          </div>
          <h1 className="text-xl md:text-2xl font-bold text-gray-900 text-balance">
            Cricket
          </h1>
        </div>
          ...
          {navLinks.map((link) => (
            <li key={link.name}>
              <a
                ...
                className="text-gray-600 text-sm font-medium uppercase tracking-widest hover:text-amber-600 transition-colors duration-300 hover:underline underline-offset-4 decoration-amber-600/50"
              >
                {link.name}
              </a>
            </li>
        ...
        <button
          ...
          className="md:hidden text-gray-600 hover:text-amber-600 transition-colors duration-300"
        >
        ...
        {/* Mobile Nav */}
        {isOpen && (
          <div className="absolute top-full left-0 right-0 bg-white/95 border-t border-gray-200 md:hidden">
            <ul className="flex flex-col items-center gap-4 py-6">
              {navLinks.map((link) => (
                <li key={link.name}>
                  <a
                    href={`#${link.name.toLowerCase()}`}
                    className="text-gray-600 text-base font-medium uppercase tracking-widest hover:text-amber-600 transition-colors duration-300 hover:underline underline-offset-4 decoration-amber-600/50"
